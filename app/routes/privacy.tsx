	...
	return (
		<MarketingLayout>
			<section className="mx-auto w-full max-w-4xl px-6 py-16 transition-colors duration-300">
				...
				<h1 className="mt-4 text-4xl font-semibold text-neutral-900 dark:text-white">Privacy Policy</h1>
				...
				<div className="mt-10 space-y-10 text-neutral-600 dark:text-neutral-400">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">1. Information We Collect</h2>
						<p className="mt-4">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">2. How We Use Information</h2>
						<p className="mt-4">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">3. How Information Is Shared</h2>
						<p className="mt-4">
							We share information only as necessary and under strict controls:
						</p>

						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">3.1 Within Teams</h3>
						<p className="mt-2">
						...
						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">3.2 Service Providers</h3>
						<p className="mt-2">
						...
						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">3.3 Legal Requirements</h3>
						<p className="mt-2">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">4. Data Retention</h2>
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">5. User Rights and Choices</h2>
						<p className="mt-4">
							Depending on your location, you may have the following rights:
						</p>

						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">5.1 Access and Correction</h3>
						<p className="mt-2">
							You may access and update your account information through the app.
						</p>

						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">5.2 Deletion</h3>
						<p className="mt-2">
						...
						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">5.3 Data Portability</h3>
						<p className="mt-2">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">6. Children's Privacy (COPPA)</h2>
						<p className="mt-4">
							LaneLines is designed for organized youth sports and involves children under 13.
						</p>
						<h3 className="mt-6 text-lg font-semibold text-neutral-900 dark:text-white">Key Protections:</h3>
						<ul className="mt-3 list-disc space-y-1 pl-6">
							<li>
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">8. Security</h2>
						<p className="mt-4">
					...
					<div className="transition-colors duration-300">
						<h2 className="text-2xl font-semibold text-neutral-900 dark:text-white">9. Changes to This Policy</h2>
						<p className="mt-4">
